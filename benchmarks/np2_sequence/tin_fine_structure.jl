...
function execute_np2_fine_structure(element::String, filepath::String, F2_val::Float64, is_term_dependent::Bool=true)
    ...
    element_n_map = Dict("C" => 2, "Si" => 3, "Ge" => 4, "Sn" => 5)
    if !haskey(element_n_map, element)
        error("Element not supported in this mapping. Please use C, Si, Ge, or Sn.")
    end
...
# Example Execution
execute_np2_fine_structure("Sn", "tin_rohf_results_3P_R30.0_ad1.000.jld2", 0.147232, true) 
