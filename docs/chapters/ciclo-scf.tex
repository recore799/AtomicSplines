...
\todo{Falta la cita de elementos finitos para \emph{lifting}/condensación estática. La bibliografía actual no tiene ningún texto de FEM: hay que agregar uno (p.ej. un Zienkiewicz o un Strang-Fix) a docs/bib/bibliografia.bib antes de citarlo aquí.}
