...
Los dos factores de la Ecuación \eqref{eq:mezcla_perturbativa} están sesgados en el mismo sentido en nuestro cálculo. El numerador es demasiado pequeño, porque el Cuadro \ref{tab:zeta} muestra que $\zeta_{np}$ se queda un $10\%$ por debajo del valor requerido en el germanio y un $16\%$ en el estaño. El denominador es demasiado grande, porque el término $^1D_2$ queda sistemáticamente alto respecto al experimento en los dos elementos. Un numerador deficitario y un denominador excesivo se combinan de forma multiplicativa, y su efecto conjunto da cuenta holgadamente del factor cercano a dos que separa la mezcla calculada de la observada.

Esta lectura permite además descartar la explicación que resultaría más natural, que sería atribuir el déficit a un espacio de configuraciones insuficiente. La Sección \ref{sec:convergencia_ci} estableció que ese espacio está convergido, y el cálculo no se limita a excitaciones hacia un canal particular sino que incluye todas las parejas $nl^2$ compatibles con la simetría del término hasta $l_{\max}=3$. Ampliarlo no modificaría de manera apreciable ninguno de los dos factores de la Ecuación \eqref{eq:mezcla_perturbativa}. La corrección de polarización del core sí actúa sobre el numerador y desplaza el factor $g$ en la dirección correcta, hasta un $0.94\%$ de mezcla en el germanio y un $6.69\%$ en el estaño, pero no alcanza a cerrar la brecha porque simultáneamente empeora el denominador al elevar el término $^1D_2$.
