...
# Parámetros ajustados para la condición de cúspide en r=0 como la cola exponencial
R_MAX = 60.0       # Caja grande para contener estados excitados difusos
N_ELEMS = 60       # Pocos elementos, pero bien distribuidos
ORDER = 6          # Alto orden mejora la exactitud
GAMMA = 2.5        # Factor de concentración exponencial cerca del núcleo
...
for orb in hydrogen.orbitals
    # Ensambla H (con su l), resuelve y guarda E y coeffs
...
# Graficamos solo los primeros 20 a.u.
...
display(p)
savefig(p, "orbitales_hidrogeno.png")
