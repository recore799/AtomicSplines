...
@load "radon_results_R20.0.jld2" orbitals E_total R_max
...
function plot_radon(basis::BSplineBasis, orbitals::Vector{Orbital}, R_max::Float64)
...
function plot_radon_density(basis::BSplineBasis, orbitals::Vector{Orbital}, R_max::Float64)
    ...
    savefig(p, "radon_total_density.pdf")
end
...
plot_radon(basis, orbitals, R_max)
plot_radon_density(basis, orbitals, R_max)
